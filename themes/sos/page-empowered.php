<?php
/* for Empowered dance series page */
get_header();
?>
    	<div class="contentPage">
				...
				<div class="eventbox plainbox left">
					...
					if($images = get_children(array(
						...
						<ul class="carousel">
							<li>
								<iframe width="610" height="343" src="http://www.youtube.com/embed/EmH4YlNdWAg?rel=0" frameborder="0" allowfullscreen></iframe>
							</li>
							<li>
								<iframe width="610" height="343" src="http://www.youtube.com/embed/H7_sqdkaAfo?rel=0" frameborder="0" allowfullscreen></iframe>
							</li>
							<li>
