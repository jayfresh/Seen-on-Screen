<?php
/* for Confident dance series page */
get_header();
?>
				...
				<div class="eventbox plainbox left">
					...
					if($images = get_children(array(
						...
						<ul class="carousel">
							...
							<li>
								<iframe width="610" height="343" src="http://www.youtube.com/embed/RQa7SvVCdZk?rel=0" frameborder="0" allowfullscreen></iframe>
							</li>
							<li>
								<iframe width="610" height="343" src="http://www.youtube.com/embed/9ZyKF3KaK5s?rel=0" frameborder="0" allowfullscreen></iframe>
							</li>
							<li>
