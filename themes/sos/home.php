<?php get_header(); ?>
				...
				<div class="rightpane left marginright">
					...
					<p><strong>Book in for Beyonc&eacute; 'Love On Top' workshop on Saturday June 23rd <a href="<?php bloginfo('url'); ?>/workshops">here</a>! For our weekly Wednesday classes & the 6-week course book <a href="<?php bloginfo('url'); ?>/regular-classes">here</a></strong></p>
