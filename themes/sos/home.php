<?php get_header(); ?>
				...
				<div class="rightpane left marginright">
					...
					<p><strong>Book in for Jay Z &amp; Kanye West 'Watch The Throne' workshop on Saturday May 19th <a href="<?php bloginfo('url'); ?>/workshops">here</a>! For our weekly Wednesday classes & the 6-week course book <a href="<?php bloginfo('url'); ?>/regular-classes">here</a></strong></p>
