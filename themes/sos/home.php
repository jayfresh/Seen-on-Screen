<?php get_header(); ?>
				...
				<div class="rightpane left marginright">
					...
					<p><strong>You can book in for our exclusive Rihanna Workshop this Saturday 28th April with Rihanna's backing dancer <a href="<?php bloginfo('url'); ?>/workshops">here</a>! For our weekly Wednesday classes & the 6-week course book <a href="<?php bloginfo('url'); ?>/regular-classes">here</a></strong></p>
