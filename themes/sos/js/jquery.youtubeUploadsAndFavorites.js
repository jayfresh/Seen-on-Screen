...
;(function($){
    ...
    $.fn.youtubeChannel = function(settings) {
                ...
                if (data.feed.entry) {
                    ...
                    for (var i=0; i<length; i++) {
                        ...
                        listHtml += addVideo({
                            ...
                            // JRL modification to get thumbnail 3 (.../1.jpg)
                            thumb:      (e ? e.media$group.media$thumbnail[3].url : ''),
        ...
        // JRL addition to allow custom layout
        if(settings.addVideo) {
        	addVideo = settings.addVideo;
        }
        /*  -- PLUGIN MAIN CODE --  */
