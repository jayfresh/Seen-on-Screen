<?php
/* for Christina Aguilera dance series page */
get_header();
?>
    	<div class="contentPage">
				...
				<div class="eventbox plainbox left">
					...
					if($images = get_children(array(
						...
						<ul class="carousel">
							<li>
								<iframe width="610" height="343" src="http://www.youtube.com/embed/2xMWrKhLJq4?rel=0" frameborder="0" allowfullscreen></iframe>
							</li>
