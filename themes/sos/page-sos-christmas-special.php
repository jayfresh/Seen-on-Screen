<?php
/* for SoS Christmas Special workshop page */
get_header();
?>
    	<div class="contentPage">
				...
				<div class="eventbox plainbox left">
					...
					if($images = get_children(array(
						...
						<ul class="carousel">
							<li>
								<iframe width="610" height="343" src="http://www.youtube.com/embed/yXQViqx6GMY?rel=0" frameborder="0" allowfullscreen></iframe>
							</li>
