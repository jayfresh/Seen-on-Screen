<?php
/* for Battle of The Boy Bands dance series page */
get_header();
?>
    	<div class="contentPage">
				...
				<div class="eventbox plainbox left">
					...
					if($images = get_children(array(
						...
						<ul class="carousel">
							<li>
								<iframe width="610" height="343" src="http://www.youtube.com/embed/TWZKw_MgUPI?rel=0" frameborder="0" allowfullscreen></iframe>
							</li>
							<li>
								<iframe width="610" height="343" src="http://www.youtube.com/embed/6M6samPEMpM?rel=0" frameborder="0" allowfullscreen></iframe>
							</li>
							<li>
								<iframe width="610" height="343" src="http://www.youtube.com/embed/Eo-KmOd3i7s?rel=0" frameborder="0" allowfullscreen></iframe>
							</li>
