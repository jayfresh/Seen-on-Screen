...
function initSameHeight() {
	...
	jQuery('.classes-block').sameHeight({
		elements: '.quote-holder,.level-block',
		flexible: true,
		multiLine: true,
		biggestHeight: true
	});
	jQuery('.col-container').sameHeight({
		elements: '.quote-holder,.text-block',
		flexible: true,
		multiLine: true,
		biggestHeight: true
	});
	jQuery('.contact-block').sameHeight({
		elements: '.contact-form,.social-block',
		flexible: true,
		multiLine: true,
		biggestHeight: true
	});
	jQuery('.tabset-section').sameHeight({
		elements: '.tabset,.tab-content',
		flexible: true,
		multiLine: true,
		biggestHeight: true
	});
